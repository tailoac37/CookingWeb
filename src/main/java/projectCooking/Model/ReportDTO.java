...
public class ReportDTO {
    ...
    public ReportDTO(Integer reportId, Integer reporterId, String reporterName, 
                     Integer recipeId, String recipeTitle, Integer reportedUserId, 
                     String reportedUserName, ReportReason reason, String description, 
                     ReportStatus status, String adminNote, LocalDateTime createdAt, 
